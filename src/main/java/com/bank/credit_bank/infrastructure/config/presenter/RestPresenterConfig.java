...
import com.bank.credit_bank.infrastructure.presenter.rest.delegate.CardManagementDelegate;
import com.bank.credit_bank.infrastructure.presenter.rest.delegate.CardManagementDelegateImpl;
import com.bank.credit_bank.infrastructure.presenter.rest.mapper.*;
import org.springframework.context.annotation.Bean;
import org.springframework.context.annotation.Configuration;

@Configuration
public class RestPresenterConfig {

    @Bean
    public CardManagementDelegate cardManagementDelegate(CardCreateService cardCreateService,
        ...
        return new CardManagementDelegateImpl(cardCreateService,
                cardCloseService,
                cardFindByIdService,
