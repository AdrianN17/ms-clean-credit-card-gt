 ...
 *         <element name="data" type="{http://bank.com/credit_card}PaymentResponseList"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class RetrievePaymentResponse {
    ...
    @XmlElement(required = true)
    protected PaymentResponseList data;
     ...
     * @return
     *     possible object is
     *     {@link PaymentResponseList }
     *     
     */
    public PaymentResponseList getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(PaymentResponseList value) {
        this.data = value;
    }
