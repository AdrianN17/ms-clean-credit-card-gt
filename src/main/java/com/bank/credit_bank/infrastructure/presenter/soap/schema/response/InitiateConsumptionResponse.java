 ...
 *         <element name="data" type="{http://bank.com/credit_card}UUIDResponse"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "initiateConsumptionResponse")
public class InitiateConsumptionResponse {

    @XmlElement(required = true)
    protected Tracking tracking;
    @XmlElement(required = true)
    protected UUIDResponse data;
     ...
     *     
     */
    public void setData(UUIDResponse value) {
        this.data = value;
    }
