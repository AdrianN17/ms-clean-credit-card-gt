...
public class ConsumptionPersistanceMapperCosmosImpl implements ConsumptionPersistanceMapperCosmos {
    ...
    @Override
    public ConsumptionResponseDto toDomain(ConsumptionEntityCosmos entity, CurrencyRequestDto currency) {
    ...
    @Override
    public ConsumptionEntityCosmos toEntity(ConsumptionRequestDto consumption) {
