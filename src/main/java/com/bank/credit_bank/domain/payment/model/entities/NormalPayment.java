...
public class NormalPayment extends AggregateRoot<PaymentId> implements Payment {
    ...
    public static class NormalPaymentBuilder {
        ...
        public NormalPaymentBuilder paymentAmount(BigDecimal amount, String currency, BigDecimal exchangeRate) {
        ...
        public NormalPaymentBuilder channelPayment(String channelPayment) {
