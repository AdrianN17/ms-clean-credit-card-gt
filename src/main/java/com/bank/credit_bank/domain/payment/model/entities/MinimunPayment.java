...
public class MinimunPayment extends AggregateRoot<PaymentId> implements Payment {
    ...
    public static class MinimunPaymentBuilder {
        ...
        public MinimunPaymentBuilder paymentAmount(BigDecimal amount, String currency, BigDecimal exchangeRate) {
        ...
        public MinimunPaymentBuilder channelPayment(String channelPayment) {
